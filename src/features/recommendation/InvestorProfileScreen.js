...
export function renderInvestorProfile(root) {
  ...
  if (
    ...
    root
      .querySelector("#startAssessmentBtn")
  ...
  root.querySelector("#profileHeadline").textContent =
    stage.headline;

  root.querySelector("#profileSummary").textContent =
  ...
  root.querySelector("#stageName").textContent =
    stage.name;

  root.querySelector("#stageCopy").textContent =
    stage.summary;

  root.querySelector("#styleName").textContent =
    style.name;

  root.querySelector("#styleCopy").textContent =
    style.copy;

  root.querySelector("#modifierName").textContent =
    modifier.name;

  root.querySelector("#modifierCopy").textContent =
    modifier.copy;

  root.querySelector("#stageEvidence").innerHTML =
    evidence(
      state,
      EVIDENCE_MAP.stage
    );

  root.querySelector("#styleEvidence").innerHTML =
    evidence(
      state,
      EVIDENCE_MAP.style
    );

  root.querySelector("#modifierEvidence").innerHTML =
    evidence(
      state,
