...
export function loadState(){try{return JSON.parse(sessionStorage.getItem(KEY))||emptyState();}catch{return emptyState();}}
export function saveState(state){sessionStorage.setItem(KEY,JSON.stringify(state));}
export function resetState(){sessionStorage.removeItem(KEY);}
